...
export default function PreviewPane() {
    ...
    async function startWebPreview() {
        if (!supportsServerProjectPreview) {
            setWebPreviewError("Project server previews need the larger Oracle deployment. This AWS version keeps browser previews and the terminal available for supported work.");
            return;
        }
    ...
    return (<div className="preview-panel">
      <div className="preview-toolbar">
        ...
        {projectFolder && supportsServerProjectPreview && !webPreview && <button className="btn btn-secondary" onClick={() => void startWebPreview()} disabled={webPreviewStarting} style={{ padding: "0.2rem 0.55rem", fontSize: 11, flexShrink: 0 }}>
